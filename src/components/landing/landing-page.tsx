  ...
  return <div className={styles.page}>
    ...
    <main id="main-content">
      ...
      <section className={`${styles.section} ${styles.direction}`} id="decisions" aria-labelledby="decisions-heading">
        ...
        <section className={styles.cycleSection} aria-labelledby="blueprint-heading"><div className={styles.cycleIntro}><div><p className={styles.chapter}>Process artifact / Service blueprint</p><h3 id="blueprint-heading">Follow the people<br />and the evidence.</h3></div><p>The FigJam blueprint maps the crew, supervisor and partner across collection, review and sharing. It makes ownership, frontstage actions and backstage dependencies explicit.</p></div><figure className={styles.cycleFigure}><a href="/assets/journey-blueprint.png" target="_blank" rel="noreferrer" aria-label="Open full-size service blueprint"><Image src="/assets/journey-blueprint.png" alt="Seven-stage service blueprint following evidence from capture through review and sharing, with roles, touchpoints and ownership." width={2230} height={1081} sizes="(max-width:767px) 100vw, 1142px" /></a><figcaption><span>Working service blueprint · Proposed journey and assumptions</span><a href="https://www.figma.com/board/qdbKTuDN054FcmO2aOxauJ?node-id=3-85" target="_blank" rel="noreferrer">Explore in FigJam <MoveUpRight size={14} aria-hidden="true" /></a></figcaption></figure></section>
        <details className={styles.journeyDetail}><summary>View the journey-flow exploration</summary><a href="/assets/journey-board.png" target="_blank" rel="noreferrer"><Image src="/assets/journey-board.png" alt="Original FigJam board with field capture and office planning journey explorations, service blueprint and state model." width={4800} height={2829} sizes="(max-width:767px) 100vw, 1142px" /></a><p>Office planning is a phase-two exploration. <a href="https://www.figma.com/board/qdbKTuDN054FcmO2aOxauJ?node-id=1-3" target="_blank" rel="noreferrer">Open editable journey flows ↗</a></p></details><div className={styles.researchFindings}><h3>Evidence behind the direction</h3><p>FWS guidance covers nests with eggs, chicks or dependent young. A photo with no visible adult cannot settle nest status. <a href="https://www.fws.gov/story/bird-nests">FWS nest guidance ↗</a></p><p>Eagle nests receive protection even when unoccupied. We keep species and nesting separate; the fictional scenario does not encode legal clearance. <a href="https://www.fws.gov/program/eagle-management/eagle-nest-removal-permits">FWS eagle guidance ↗</a></p><p>Visible system status helps people understand what happened. Upload, analysis and crew receipt therefore stay separate. <a href="https://www.nngroup.com/articles/ten-usability-heuristics/">NN/g usability heuristics ↗</a></p></div>
      </section>
