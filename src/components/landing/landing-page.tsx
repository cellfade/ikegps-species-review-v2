...
<section id="sources" className={`${styles.section} ${styles.artifacts}`} aria-labelledby="artifacts-heading">
          ...
          <details className={styles.resources}><summary>Design artifacts & review notes</summary><div className={styles.resourceGrid}>
            <div><h3>Framing & working prototype</h3><a href="https://perch-ikegps.vercel.app/documents/endangered-species-problem-framing.pdf" target="_blank" rel="noreferrer">Submitted two-page framing ↗</a><a href="https://ikegps-species-review-v2.vercel.app/" target="_blank" rel="noreferrer">Live V2 presentation ↗</a><a href="https://ikegps-species-review-v2.vercel.app/prototype" target="_blank" rel="noreferrer">Live V2 prototype ↗</a><a href="https://github.com/cellfade/ikegps-species-review-v2" target="_blank" rel="noreferrer">GitHub repository · Public ↗</a></div>
            ...
            <div><h3>Planning & review notes</h3><a href="/documents/review-feedback-resolution.md">Review feedback resolution · Markdown</a><a href="/documents/phase-two-entry-points.md">Phase two entry points · Markdown</a><a href="/documents/prototype-v2-plan.md">V2 plan · Markdown</a><a href="/documents/phase-one-terminology.md">Journey terminology · Markdown</a><a href="/documents/current-refinement-qa.md">Current refinement QA · Markdown</a><a href="/documents/design-exercise-alignment.md">Design exercise alignment · Markdown</a><a href="/documents/landing-source-alignment.md">Submitted-source alignment · Markdown</a><a href="/documents/reviewer-identification-guidance.md">Identification guidance · Markdown</a><a href="/documents/landing-comparative-taste-audit.md">Comparative design audit · Markdown</a></div>
