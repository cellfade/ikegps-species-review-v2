...
export function LandingPage() {
  return <div className={styles.page}>
    ...
    <main id="main-content">
      ...
      <section className={`${styles.section} ${styles.expansion}`} id="expansion" aria-labelledby="expansion-heading"><div className={styles.sectionIntro}><div><p className={styles.chapter}>06 / Further exploration</p><h2 id="expansion-heading">Where I stopped.<br />What could come next.</h2></div><p>I stopped at the crew-to-supervisor work decision. Background analysis, planning checks and conservation sharing are opportunities for further exploration—not completed workflows.</p></div>
          <details className={styles.explorationDetails}><summary>Optional concepts: background analysis, planning &amp; conservation</summary>
          ...
          <p className={styles.expansionBoundary}>Phase-two concepts · Synthetic map data · Analysis triggers, conservation filters and sharing preview are simulated. No AI jobs or public-sharing service run in this prototype.</p></details>
        </section>
